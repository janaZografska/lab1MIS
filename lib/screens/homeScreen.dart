...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Exam> exams = [
      ...
      Exam(subj: "Бази на податоци", dateTime: DateTime(2025, 11, 19, 8, 0), room: ["лаб. 2", "лаб. 3", "лаб. 12"]),
      Exam(subj: "Тестирање на софтвер", dateTime: DateTime(2025, 11, 20, 18, 0), room: ["лаб. 2", "лаб. 3"]),
      Exam(subj: "Алгоритми и податочни структури", dateTime: DateTime(2025, 10, 21, 8, 0), room: ["лаб. 2", "лаб. 3", "лаб. 12"]),
      Exam(subj: "Калкулус", dateTime: DateTime(2025, 11, 21, 10, 0), room: ["Б2.2", "Б3.2"]),
      Exam(subj: "Компјутерски мрежи и безбедност", dateTime: DateTime(2025, 11, 22, 8, 0), room: ["лаб. 13", "лаб. 138"]),
      Exam(subj: "Вовед во наука за податоци", dateTime: DateTime(2025, 10, 29, 8, 0), room: ["лаб. 2", "лаб. 3", "лаб. 138"]),
